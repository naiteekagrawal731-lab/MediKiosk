...
import com.sih.MediKiosk.dtos.responseDtos.*;
...
public class PatientController {
    ...
    public ResponseEntity<?> createNewPatient(@RequestBody CreatePatientRequest request){
        ResponseEntity<?> response = patientService.createNewPatient(request);
        return response;
    }

    @PostMapping("/login")
    public ResponseEntity<LoginResponse> login(@RequestBody PatientLoginRequest request){
